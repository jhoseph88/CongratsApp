...
public class InfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(edu.umich.engin.congrats.R.layout.activity_info);
        ...
        TextView infoText = (TextView) findViewById(edu.umich.engin.congrats.R.id.infoText);
        infoText.setText(infoString);

        String infoPageHeader = "<b>ABOUT & CONTACT<b><br>";
        TextView infoHeader = (TextView) findViewById(edu.umich.engin.congrats.R.id.infoHeader);
        ...
        TextView appEmailView = (TextView) findViewById(edu.umich.engin.congrats.R.id.appContactEmail);
        ...
        TextView admissionsEmailView = (TextView) findViewById(edu.umich.engin.congrats.R.id.admissionsContactEmail);
