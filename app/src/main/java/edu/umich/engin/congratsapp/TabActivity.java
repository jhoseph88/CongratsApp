...
import edu.umich.engin.congratsapp.MainTabs.AcademicsTab;
import edu.umich.engin.congratsapp.MainTabs.LifeAndActivitiesTab;
import edu.umich.engin.congratsapp.MainTabs.OpportunitiesTab;
...
public class TabActivity extends android.app.TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(edu.umich.engin.congratsapp.R.layout.activity_tab);
        ...
        for (int i = 0; i < tw.getChildCount(); ++i) {
            ...
            tabHost.getTabWidget().getChildAt(i).setBackgroundColor(getResources().
                                                                    getColor(edu.umich.engin.congratsapp.R.color.NavyBlue) );
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                tabHost.getTabWidget().getChildAt(tabHost.getCurrentTab() )
                                      .setBackgroundColor(getResources().getColor(edu.umich.engin.congratsapp.R.color.Maize) );

                final View tabView = tw.getChildTabViewAt(tabHost.getCurrentTab() );
                final TextView tv = (TextView) tabView.findViewById(android.R.id.title);
                tv.setTextColor(getResources().getColor(edu.umich.engin.congratsapp.R.color.NavyBlue) );
            }// onTabChanged
        });
    }
