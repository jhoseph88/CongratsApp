...
public class LifeAndActivitiesTab extends PostTab {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(edu.umich.engin.congratsapp.R.layout.tab_activities);
        // set onclick listener to go to info page if info button clicked
        ImageButton infoButton = (ImageButton) findViewById(edu.umich.engin.congratsapp.R.id.activitiesInfoButton);
