...
class ToDoAdapter extends ArrayAdapter<ToDo> {
    ...
    public ToDoAdapter(Context context, ToDo[] resource, String[] headings) {
        super(context, edu.umich.engin.congratsapp.R.layout.row, resource);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(edu.umich.engin.congratsapp.R.layout.row, parent, false);
        TextView name = (TextView) convertView.findViewById(edu.umich.engin.congratsapp.R.id.checkListText);
        TextView heading = (TextView) convertView.findViewById(edu.umich.engin.congratsapp.R.id.stepNumberHeading);
        TextView depositReminders = (TextView) convertView.findViewById(edu.umich.engin.congratsapp.R.id.depositReminder);
        CheckBox checkBox = (CheckBox) convertView.findViewById(edu.umich.engin.congratsapp.R.id.checkBox);
        ...
        if (position == 5 || position == 6) {
            depositReminders.setText(context.getString(edu.umich.engin.congratsapp.R.string.deposit_reminder) );
        }
