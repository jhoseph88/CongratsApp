...
public class FragmentThree extends Fragment {
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(edu.umich.engin.congratsapp.R.layout.fragment_three_layout, container, false);
        Button toDoListButton = (Button)view.findViewById(edu.umich.engin.congratsapp.R.id.skipToChecklistButton);
