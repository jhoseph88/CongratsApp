...
public class CustomEntryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(edu.umich.engin.congratsapp.R.layout.list_item, null);
        }
        TextView title = (TextView) view.findViewById(edu.umich.engin.congratsapp.R.id.title);
        ...
        TextView excerpt = (TextView) view.findViewById(edu.umich.engin.congratsapp.R.id.excerpt);
        excerpt.setText(URLDecoder.decode(excerpts.get(position) ) );
        ImageView img = (ImageView) view.findViewById(edu.umich.engin.congratsapp.R.id.imageView);
