...
public class Onboarding extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(edu.umich.engin.congratsapp.R.layout.activity_onboarding);
        // Create onboarding pager with welcome screens that will be shown only once
        viewpager = (ViewPager)findViewById(edu.umich.engin.congratsapp.R.id.pager);
        edu.umich.engin.congratsapp.PagerAdapter padapter = new edu.umich.engin.congratsapp.PagerAdapter(getSupportFragmentManager(), this);
